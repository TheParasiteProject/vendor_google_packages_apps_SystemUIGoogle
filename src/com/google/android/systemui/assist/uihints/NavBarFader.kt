...
class NavBarFader(
    ...
    init {
        val defaultNavigationBarView =
            (navigationBarController as NavigationBarControllerImpl).defaultNavigationBarView
    ...
    override fun onVisibleRequest(visible: Boolean) {
        ...
        animator =
            ObjectAnimator.ofFloat(defaultNavigationBarView, View.ALPHA, currentAlpha, newAlpha)
                .apply {
