...
class AmbientIndicationContainer(private val context: Context, attrs: AttributeSet) :
    ...
    fun initializeView(
        ...
        wakeLock =
            DelayedWakeLock(bgHandler, mainHandler, context, wakeLockLogger, "AmbientIndication")
        addInflateListener {
    ...
    private fun updateHorizontalSpacing() {
        ...
        (layoutParams as FrameLayout.LayoutParams).apply { this.marginStart = marginStart }
    }
